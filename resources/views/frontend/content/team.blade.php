                            ...
                            <div class="team-item-wrap">
                                <div class="team-wrap">
                                    <div class="image-inner">
                                        <a href="#"><img src="{{ asset('/setting/banner/' . $activitie->image) }}" alt=""></a>
                                    </div>
                                </div>
                                <div class="team-content text-center">
                                    <h4 class="person-name"><a href="#">{{ $activitie->title }}</a></h4>
                                    <span class="designation">{{ $activitie->sort_para }}</span>
