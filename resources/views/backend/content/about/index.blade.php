...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <form class="form-horizontal" action="{{ route('admin.setting.about.store') }}" enctype="multipart/form-data" method="POST">
                    @csrf
                    @if ($about != null)
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" col="10" row="5" name="short_description">{{ $about->short_description ?? '' }}</textarea>
                    </div>
                    ...
                    <div class="form-group">
                        <label>Details</label>
                        <textarea id="" class="editor form-control" col="10" row="3" name="description">{!! $about->description ?? '' !!}</textarea>
                    </div>
            ...
            <table id="example" class="table table-striped" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.setting.about.edit', ['id' => $about->id]) }}" class="btn btn-success">
